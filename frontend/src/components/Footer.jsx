/* ─────────────────────────────────────────────────────────────
   Footer.jsx — PolicyPal global footer
   ───────────────────────────────────────────────────────────── */
    ...
    <footer style={{ background: NAVY }}>
      ...
      <div className="max-w-6xl mx-auto px-6 pt-14 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            <Link to="/" className="flex items-center gap-2 w-fit group">
              ...
              <span className="text-white font-black text-xl tracking-tight">PolicyPal</span>
              <span className="w-2 h-2 rounded-full -ml-1 mt-0.5 self-start shrink-0
            ...
            <p className="text-sm text-gray-400 leading-relaxed max-w-xs">
              ...
              plain-English summaries, coverage maps, and instant answers in under 60 seconds.
            </p>
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-between gap-4
          ...
          <div>
            <p className="text-white font-bold text-sm">Ready to decode your policy?</p>
            <p className="text-gray-400 text-xs mt-0.5">Free to try. No credit card required.</p>
          </div>
          <Link
            to="/upload"
      ...
      {/* Bottom bar */}
      <div className="border-t max-w-6xl mx-auto px-6 py-5 flex flex-col sm:flex-row
                      items-center justify-between gap-3"
        style={{ borderColor: "rgba(255,255,255,0.07)" }}>
        <p className="text-xs text-gray-500">
          © {year} PolicyPal. Built for the Fintech Hackathon. All rights reserved.
        </p>
        <div className="flex items-center gap-1.5 text-xs text-gray-600">
          <span>Made with</span>
          <span style={{ color: RED }}>♥</span>
          <span>using React + Gemini AI</span>
        </div>
      </div>
    </footer>
  );
