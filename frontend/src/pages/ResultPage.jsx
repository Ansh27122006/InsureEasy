...
const DEMO_DATA = {
  ...
  notCovered: [
    { title: "Flood Damage",       description: "Rising water, storm surge, and sewer backup are explicitly excluded.", icon: "🌊" },
    { title: "Earthquake Damage",  description: "Structural damage from seismic activity is not covered under this policy.", icon: "🌍" },
    { title: "Intentional Acts",   description: "Any damage caused intentionally by the insured is excluded.", icon: "⛔" },
    { title: "Business Activities",description: "Losses arising from running a business at the property are not covered.", icon: "💼" },
  ],
  partialCoverage: [
    { title: "Water Damage", description: "Only sudden/accidental covered. Gradual leaks excluded.", icon: "💧", covered: "Burst pipes", notCovered: "Slow leaks" },
  ],
  keyTerms: [
    { term: "Deductible",       definition: "The amount you pay out-of-pocket before your insurance kicks in." },
    { term: "Premium",          definition: "The amount you pay monthly or annually to keep your policy active." },
    { term: "Liability",        definition: "Your legal responsibility if someone is injured or their property is damaged." },
    { term: "Replacement Cost", definition: "What it costs to replace or repair your property at today's prices." },
    { term: "Exclusion",        definition: "A specific situation or item that your policy does NOT cover." },
    { term: "Endorsement",      definition: "An amendment to your policy that adds, removes, or changes coverage." },
  ],
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 py-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <span className="text-white font-bold text-sm truncate">{policyName}</span>
                </div>
              </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              <div className="flex-1 min-w-0">
                ...
                {summary && (
                  <p className="text-sm text-gray-300 leading-relaxed max-w-lg mb-6">{summary}</p>
                )}
                <div className="grid grid-cols-3 gap-3 max-w-sm">
                  ...
                  <StatCard value={keyTerms.length}   label="Key Terms"     color="#FBBF24" icon="📖" />
                </div>
              </div>
          ...
          <div key={activeTab} className="tab-enter">
            ...
            {activeTab === "terms" && (
              <div className="flex flex-col gap-4">
                <div className="mb-2">
                  <h2 className="results-heading text-2xl font-black text-gray-900">Key Terms Glossary</h2>
                  <p className="text-sm text-gray-400 mt-1">Insurance jargon, translated into plain English.</p>
                </div>
            ...
            {activeTab === "chat" && (
              <div className="flex flex-col gap-4">
                <div className="mb-2">
                  <h2 className="results-heading text-2xl font-black text-gray-900">Ask Your Policy</h2>
                  <p className="text-sm text-gray-400 mt-1">Chat directly with AI about your policy details.</p>
                </div>
