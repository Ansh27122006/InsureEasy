...
const PDFIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8}
    ...
    <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" />
    <polyline points="14 2 14 8 20 8" />
    <text x="6" y="18" fontSize="5" fontWeight="bold" fill="currentColor" stroke="none">PDF</text>
  </svg>
);
...
export default function UploadPage() {
  ...
  async function handleAnalyze() {
    ...
    setError("");
    try {
      const payload = activeTab === "pdf" ? file : policyText.trim();
      const data = await api.analyzePolicy(payload);
  ...
  return (
    <>
      ...
      <main className="min-h-screen flex flex-col items-center justify-center px-4 py-16"
        ...
        {/* Ambient blobs */}
        <div className="fixed top-0 left-0 w-[480px] h-[480px] rounded-full blur-[140px] pointer-events-none opacity-30"
          style={{ background: "#BFDBFE" }} />
        <div className="fixed bottom-0 right-0 w-[400px] h-[400px] rounded-full blur-[120px] pointer-events-none opacity-25"
        ...
        <div className="relative z-10 w-full max-w-2xl">
          ...
          <div className="text-center mb-9">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-4"
              style={{ background: "rgba(233,69,96,0.08)", color: RED, border: `1px solid rgba(233,69,96,0.2)` }}>
            ...
            <h1 className="upload-heading text-4xl font-black text-gray-900 leading-tight">
              ...
              <span className="relative">
                ...
                <svg className="absolute -bottom-1 left-0 w-full" viewBox="0 0 300 8" fill="none">
                  <path d="M2 6 Q75 2 150 5 Q225 8 298 4" stroke={RED} strokeWidth="2.5"
                    strokeLinecap="round" fill="none" />
                </svg>
              </span>
            </h1>
            <p className="text-gray-500 mt-4 text-base max-w-md mx-auto leading-relaxed">
              Get plain-English summaries, coverage maps, and instant answers — in under 60 seconds.
            </p>
          </div>

          {/* ── Card ── */}
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden"
            style={{ boxShadow: "0 8px 48px rgba(0,0,0,0.10), 0 1px 2px rgba(0,0,0,0.05)" }}>
            ...
            <div className="p-8 flex flex-col gap-6">
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center justify-center py-14 px-6 text-center gap-4">
                        ...
                        <div className="flex items-center gap-3 text-xs text-gray-400">
                          ...
                          <span className="px-2.5 py-1 bg-gray-100 rounded-full font-medium">Up to 50 MB</span>
              ...
              {activeTab === "text" && (
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    onFocus={(e) => e.target.style.boxShadow = `0 0 0 3px rgba(233,69,96,0.12)`}
                    onBlur={(e) => e.target.style.boxShadow = "none"}
                  />
                  <div className="flex justify-between items-center text-xs text-gray-400 px-1">
                    <span>{policyText.length > 0 ? `${policyText.length.toLocaleString()} characters` : "Minimum 20 characters"}</span>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-gray-400 font-medium uppercase tracking-widest">Ready to go</span>
                <div className="flex-1 h-px bg-gray-100" />
              </div>
              ...
              <button
                ...
                style={{
                  background: isReady && !loading
                    ...
                    : "#9CA3AF",
                  boxShadow: isReady && !loading ? `0 8px 24px rgba(233,69,96,0.35)` : "none",
                }}
              >
                {loading ? (
                  <>
          ...
          <div className="flex items-center justify-center gap-6 mt-7">
            {["SOC 2 Compliant", "256-bit Encryption", "HIPAA Ready"].map((badge) => (
              <span key={badge} className="flex items-center gap-1.5 text-xs text-gray-400 font-medium">
                <span className="w-4 h-4 rounded-full flex items-center justify-center"
                  style={{ background: "rgba(233,69,96,0.12)", color: RED, fontSize: 9 }}>✓</span>
                {badge}
              </span>
            ))}
          </div>
