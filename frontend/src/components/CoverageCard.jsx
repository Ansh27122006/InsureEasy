  ...
  partial: {
    ...
    statusIcon: (
      ...
      >
        ...
        <circle cx="10" cy="14.5" r="0.5" fill="#D97706" />
      </svg>
    ),
...
/* ── CoverageCard ─────────────────────────────────────────────  */
export function CoverageCard({ title, description, icon, type = "covered" }) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: `linear-gradient(90deg, ${cfg.border}40, transparent)` }}
      />
    </article>
  );
}
