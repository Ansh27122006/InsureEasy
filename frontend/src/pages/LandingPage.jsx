  ...
  return (
    <motion.div
      ...
      <div className="px-5 pt-5 pb-3 flex items-center justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-widest text-[#E94560]">
            Live Stats
          </p>
      ...
      <div className="relative flex flex-col items-center text-center">
        ...
        {index < total - 1 && (
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(233,69,96,0.5) 0%, rgba(233,69,96,0.1) 100%)",
              zIndex: 0,
            }}
          />
        )}
        ...
        <div className="max-w-6xl mx-auto px-6">
          <FadeUp className="text-center mb-14">
            ...
            <h2 className="hero-heading text-4xl md:text-5xl font-black text-gray-900 mt-3 leading-tight">
              Your policy, finally <span style={{ color: RED }}>decoded.</span>
            </h2>
            <p className="mt-4 text-gray-500 max-w-xl mx-auto text-base leading-relaxed">
              Three powerful tools work together to give you complete clarity
              over your coverage — no law degree required.
            </p>
          </FadeUp>
      ...
      <section
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <FadeUp className="text-center mb-16">
            ...
            <h2 className="hero-heading text-4xl md:text-5xl font-black text-gray-900 mt-3 leading-tight">
              Three steps to <span style={{ color: RED }}>clarity.</span>
            </h2>
          ...
          <FadeUp
            ...
            <motion.div
              ...
              style={{
                background: `linear-gradient(120deg, ${NAVY} 0%, ${DEEP} 100%)`,
              }}>
              <div
                className="absolute inset-0 pointer-events-none"
                style={{
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400 mt-2 text-sm max-w-md leading-relaxed">
                  Join thousands who've already stopped guessing and started
                  knowing.
                </p>
              </div>
              <motion.button
